...
import { ACTIVE_CAMPAIGN_ID, ECONOMIC_MODEL_VERSION, PURPLE_TIER_ID, TITLE_PRICE_UNITS, type PurchaseIntentRecord, type VerifiedPayment } from './economyTypes.js';
